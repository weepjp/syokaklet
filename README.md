...
| ボイス名(値)    | 変数  | 役割  | 
| -------------- | :---: | ---------------------------------------------------------------------------------------------------------------------------------------------- | 
| 音街ウナ        | va | `地の文`（いわゆるナレーション）。 | 
| 音街ウナ - 新規 | vb | `「」` 内の台詞。 | 
| 琴葉 茜         | vx | `エピソードタイトル` や `【～】` や `（～）` や<br>**特定の記号1文字**で始まる単発の注記・補足。 | 
| 琴葉 葵         | vy |  `『～』` や `【【～】】` `――ああ` や<br>**同じ記号の重複・連続**で始まる行。| 
