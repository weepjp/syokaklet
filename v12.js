((d = document) => {
  ...
  let parseText = (isV2) => {
    ...
    let f = -1, cutReason = "";
    let r = /お読み[い頂戴]|読んでく(ださ(って|ださり)|れて)+((ありが|有難)う|感謝|感激)|[筆著作]者から(の)?お(願|ねが|[知し]ら)|コミカライズ|書き[下お]ろし|予約[開受]|(昨日|今日|明日|[日月]に)発売|発売[さしでを日記中開決！]|書影|読者様|[短長前中後][編篇]|[0-9０-９〇一二三四五六七八九十百千万上中下\u2160-\u217B]+([巻章]|(万)?ポイント達成)|[第全][0-9０-９〇一二三四五六七八九十百千万\u2160-\u217B]+[eエ話章][がでにを]|[★☆]を(いただ|戴|頂)けたら|宣伝(です|さ|を[さ行いく])|^[-※＊●★☆■◆◇▲▽▼*()（）【】「」『』]+(お[し知]らせ|宣伝|告知|報告|連絡|業務|(面白|おもしろ)かった[！!]?|(続|つづ)きが(読みたい|気になる|楽しみ)[！!]?)[-※＊●★☆■◆◇▲▽▼*()（）【】「」『』]*|(なろう|カクヨム)の(システム|機能|仕様)|ランキング[にでを]|ブックマーク|ブクマ|お気に[入い]り(に?登録|して)|(次回|次|[日月火水木金土]曜?日?)[はにの]?(更新|予定)|更新([とに]なり|未定|はお休み|する予定|の予定|予定|するので|します|するかも|し[な無]かった|[な無]かった)|(たくさん|沢山の)(感想|励まし|はげまし|コメ)|(ほか|他|別)の(お話|作品|拙作)は(いかが|書籍|書籍化|如何)|最[新終]話|[誤脱]字|他作|拙作|番外|閑話|書籍[のを化]|裏設定|ポイント[とや]感想|☆☆☆|★★★|http/;
