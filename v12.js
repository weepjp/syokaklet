((d = document) => {
  ...
  let parseText = (isV2) => {
    ...
    let f = -1, cutReason = "";
    let r = /お読み[い頂戴]|の話を読んでみ|読んでく(ださ(って|ださり)|れて)+((ありが|有難)う|感謝|感激)|[筆著作]者からの?お(願|ねが|[知し]ら)|コミカライズ|お知らせ(があります|です)|書き[下お]ろし|予約[開受]|(昨日|今日|明日|[日月]に)発売|発売[さしでを日記中開決！]|書影|読者様|[短長前中後][編篇]|[0-9０-９〇一二三四五六七八九十百千万上中下\u2160-\u217B]+([巻章]|(万)?ポイント達成)|[第全][0-9０-９〇一二三四五六七八九十百千万\u2160-\u217B]+[eエ話章][がでにを]|[★☆]を(いただ|戴|頂)けたら|宣伝(です|さ|を[さ行いく])|^[-※＊●★☆■◆◇▲▽▼*()（）【】「」『』]+(お[し知]らせ|宣伝|告知|報告|連絡|業務|(面白|おもしろ)かった[！!]?|(続|つづ)きが(読みたい|気になる|楽しみ)[！!]?)[-※＊●★☆■◆◇▲▽▼*()（）【】「」『』]*|(なろう|カクヨム)の(システム|機能|仕様)|ランキング[にでを]|ブックマーク|ブクマ|お気に[入い]り(に?登録|して)|(次(回|週)?|来週|都合により|[日月火水木金土]曜?日?)[はにの]?(更新|予定)|更新(が|再開|[とに]なり|未定|はお休み|(する|の)?予定|する(ので|します|かも)|を[減増あ上]|し?[な無]かった)|(たくさん|沢山)の(感想|励まし|はげまし|コメ)|(ほか|[他別])の(お話|作品|拙作)は?(いかが|如何|書籍化?)?|最[新終]話|[誤脱]字|[他拙]作|番外|閑話|既読の|書籍[のを化]|裏設定|(いいね|評価|リアクション|コメント)(機能|システム|有難う|ありがとう|待ってます|感謝)|ポイント[とや]感想|☆☆☆|★★★|http/;
